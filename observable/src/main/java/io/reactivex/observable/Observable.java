...
public abstract class Observable<T> implements ObservableSource<T> {
    ...
    public static <T> Observable<T> amb(Iterable<? extends ObservableSource<? extends T>> sources) {
        ...
        return RxJavaObservablePlugins.onAssembly(new ObservableAmb<T>(null, sources));
    }
    ...
    public static <T> Observable<T> ambArray(ObservableSource<? extends T>... sources) {
        ...
        return RxJavaObservablePlugins.onAssembly(new ObservableAmb<T>(sources, null));
    }
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public static <T, R> Observable<R> combineLatest(Function1<? super Object[], ? extends R> combiner, int bufferSize, ObservableSource<? extends T>... sources) {
    ...
    public static <T, R> Observable<R> combineLatest(Iterable<? extends ObservableSource<? extends T>> sources,
        ...
        int s = bufferSize << 1;
        return RxJavaObservablePlugins.onAssembly(new ObservableCombineLatest<T, R>(null, sources, combiner, s, false));
    }
    ...
    public static <T, R> Observable<R> combineLatest(ObservableSource<? extends T>[] sources,
        ...
        // the queue holds a pair of values so we need to double the capacity
        int s = bufferSize << 1;
        return RxJavaObservablePlugins.onAssembly(new ObservableCombineLatest<T, R>(sources, null, combiner, s, false));
    }
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public static <T, R> Observable<R> combineLatestDelayError(Function1<? super Object[], ? extends R> combiner,
    ...
    public static <T, R> Observable<R> combineLatestDelayError(ObservableSource<? extends T>[] sources,
        ...
        // the queue holds a pair of values so we need to double the capacity
        int s = bufferSize << 1;
        return RxJavaObservablePlugins.onAssembly(new ObservableCombineLatest<T, R>(sources, null, combiner, s, true));
    }
    ...
    public static <T, R> Observable<R> combineLatestDelayError(Iterable<? extends ObservableSource<? extends T>> sources,
        ...
        // the queue holds a pair of values so we need to double the capacity
        int s = bufferSize << 1;
        return RxJavaObservablePlugins.onAssembly(new ObservableCombineLatest<T, R>(null, sources, combiner, s, true));
    }
    ...
    public static <T> Observable<T> concat(Iterable<? extends ObservableSource<? extends T>> sources) {
        ObjectHelper.requireNonNull(sources, "sources is null");
        return fromIterable(sources).concatMapDelayError((Function1) Functions.identity(), bufferSize(), false);
    }
    ...
    public static <T> Observable<T> concat(ObservableSource<? extends ObservableSource<? extends T>> sources, int prefetch) {
        ...
        return RxJavaObservablePlugins.onAssembly(new ObservableConcatMap(sources, Functions.identity(), prefetch, ErrorMode.IMMEDIATE));
    }
    ...
    public static <T> Observable<T> concatArray(ObservableSource<? extends T>... sources) {
        ...
        return RxJavaObservablePlugins.onAssembly(new ObservableConcatMap(fromArray(sources), Functions.identity(), bufferSize(), ErrorMode.BOUNDARY));
    }
    ...
    public static <T> Observable<T> concatArrayEager(int maxConcurrency, int prefetch, ObservableSource<? extends T>... sources) {
        return fromArray(sources).concatMapEagerDelayError((Function1) Functions.identity(), maxConcurrency, prefetch, false);
    }
    ...
    public static <T> Observable<T> concatDelayError(ObservableSource<? extends ObservableSource<? extends T>> sources, int prefetch, boolean tillTheEnd) {
        ...
        return RxJavaObservablePlugins.onAssembly(new ObservableConcatMap(sources, Functions.identity(), prefetch, tillTheEnd ? ErrorMode.END : ErrorMode.BOUNDARY));
    }
    ...
    public static <T> Observable<T> concatEager(ObservableSource<? extends ObservableSource<? extends T>> sources, int maxConcurrency, int prefetch) {
        ...
        return wrap(sources).concatMapEager((Function1) Functions.identity(), maxConcurrency, prefetch);
    }
    ...
    public static <T> Observable<T> concatEager(Iterable<? extends ObservableSource<? extends T>> sources, int maxConcurrency, int prefetch) {
        ObjectHelper.requireNonNull(maxConcurrency, "maxConcurrency is null");
        ObjectHelper.requireNonNull(prefetch, "prefetch is null");
        return fromIterable(sources).concatMapEagerDelayError((Function1) Functions.identity(), maxConcurrency, prefetch, false);
    }
    ...
    public static <T> Observable<T> create(ObservableOnSubscribe<T> source) {
        ...
        return RxJavaObservablePlugins.onAssembly(new ObservableCreate<T>(source));
    }
    ...
    public static <T> Observable<T> defer(Callable<? extends ObservableSource<? extends T>> supplier) {
        ...
        return RxJavaObservablePlugins.onAssembly(new ObservableDefer<T>(supplier));
    }
    ...
    public static <T> Observable<T> empty() {
        return RxJavaObservablePlugins.onAssembly((Observable<T>) ObservableEmpty.INSTANCE);
    }
    ...
    public static <T> Observable<T> error(Callable<? extends Throwable> errorSupplier) {
        ...
        return RxJavaObservablePlugins.onAssembly(new ObservableError<T>(errorSupplier));
    }
    ...
    public static <T> Observable<T> fromArray(T... items) {
        ...
        return RxJavaObservablePlugins.onAssembly(new ObservableFromArray<T>(items));
    }
    ...
    public static <T> Observable<T> fromCallable(Callable<? extends T> supplier) {
        ObjectHelper.requireNonNull(supplier, "supplier is null");
        return RxJavaObservablePlugins.onAssembly(new ObservableFromCallable<T>(supplier));
    }
    ...
    public static <T> Observable<T> fromFuture(Future<? extends T> future) {
        ...
        return RxJavaObservablePlugins.onAssembly(new ObservableFromFuture<T>(future, 0L, null));
    }
    ...
    public static <T> Observable<T> fromFuture(Future<? extends T> future, long timeout, TimeUnit unit) {
        ...
        return RxJavaObservablePlugins.onAssembly(new ObservableFromFuture<T>(future, timeout, unit));
    }
    ...
    public static <T> Observable<T> fromIterable(Iterable<? extends T> source) {
        ObjectHelper.requireNonNull(source, "source is null");
        return RxJavaObservablePlugins.onAssembly(new ObservableFromIterable<T>(source));
    }
    ...
    public static <T, S> Observable<T> generate(Callable<S> initialState, BiFunction<S, Emitter<T>, S> generator,
        ...
        return RxJavaObservablePlugins.onAssembly(new ObservableGenerate<T, S>(initialState, generator, disposeState));
    }
    ...
    public static Observable<Long> interval(long initialDelay, long period, TimeUnit unit, Scheduler scheduler) {
        ...
        return RxJavaObservablePlugins.onAssembly(new ObservableInterval(Math.max(0L, initialDelay), Math.max(0L, period), unit, scheduler));
    }
    ...
    public static Observable<Long> intervalRange(long start, long count, long initialDelay, long period, TimeUnit unit, Scheduler scheduler) {
        ...
        return RxJavaObservablePlugins.onAssembly(new ObservableIntervalRange(start, end, Math.max(0L, initialDelay), Math.max(0L, period), unit, scheduler));
    }
    ...
    public static <T> Observable<T> just(T item) {
        ...
        return RxJavaObservablePlugins.onAssembly(new ObservableJust<T>(item));
    }
    ...
    public static <T> Observable<T> merge(Iterable<? extends ObservableSource<? extends T>> sources, int maxConcurrency, int bufferSize) {
        return fromIterable(sources).flatMap((Function1) Functions.identity(), false, maxConcurrency, bufferSize);
    }
    ...
    public static <T> Observable<T> mergeArray(int maxConcurrency, int bufferSize, ObservableSource<? extends T>... sources) {
        return fromArray(sources).flatMap((Function1) Functions.identity(), false, maxConcurrency, bufferSize);
    }
    ...
    public static <T> Observable<T> merge(Iterable<? extends ObservableSource<? extends T>> sources) {
        return fromIterable(sources).flatMap((Function1) Functions.identity());
    }
    ...
    public static <T> Observable<T> merge(Iterable<? extends ObservableSource<? extends T>> sources, int maxConcurrency) {
        return fromIterable(sources).flatMap((Function1) Functions.identity(), maxConcurrency);
    }
    ...
    public static <T> Observable<T> merge(ObservableSource<? extends ObservableSource<? extends T>> sources) {
        ObjectHelper.requireNonNull(sources, "sources is null");
        return RxJavaObservablePlugins.onAssembly(new ObservableFlatMap(sources, Functions.identity(), false, Integer.MAX_VALUE, bufferSize()));
    }
    ...
    public static <T> Observable<T> merge(ObservableSource<? extends ObservableSource<? extends T>> sources, int maxConcurrency) {
        ...
        return RxJavaObservablePlugins.onAssembly(new ObservableFlatMap(sources, Functions.identity(), false, maxConcurrency, bufferSize()));
    }
    ...
    public static <T> Observable<T> merge(ObservableSource<? extends T> source1, ObservableSource<? extends T> source2) {
        ObjectHelper.requireNonNull(source1, "source1 is null");
        ObjectHelper.requireNonNull(source2, "source2 is null");
        return fromArray(source1, source2).flatMap((Function1) Functions.identity(), false, 2);
    }
    ...
    public static <T> Observable<T> merge(ObservableSource<? extends T> source1, ObservableSource<? extends T> source2, ObservableSource<? extends T> source3) {
        ...
        ObjectHelper.requireNonNull(source2, "source2 is null");
        ObjectHelper.requireNonNull(source3, "source3 is null");
        return fromArray(source1, source2, source3).flatMap((Function1) Functions.identity(), false, 3);
    }
    ...
    public static <T> Observable<T> merge(
        ...
        ObjectHelper.requireNonNull(source3, "source3 is null");
        ObjectHelper.requireNonNull(source4, "source4 is null");
        return fromArray(source1, source2, source3, source4).flatMap((Function1) Functions.identity(), false, 4);
    }
    ...
    public static <T> Observable<T> mergeArray(ObservableSource<? extends T>... sources) {
        return fromArray(sources).flatMap((Function1) Functions.identity(), sources.length);
    }
    ...
    public static <T> Observable<T> mergeDelayError(Iterable<? extends ObservableSource<? extends T>> sources) {
        return fromIterable(sources).flatMap((Function1) Functions.identity(), true);
    }
    ...
    public static <T> Observable<T> mergeDelayError(Iterable<? extends ObservableSource<? extends T>> sources, int maxConcurrency, int bufferSize) {
        return fromIterable(sources).flatMap((Function1) Functions.identity(), true, maxConcurrency, bufferSize);
    }
    ...
    public static <T> Observable<T> mergeArrayDelayError(int maxConcurrency, int bufferSize, ObservableSource<? extends T>... sources) {
        return fromArray(sources).flatMap((Function1) Functions.identity(), true, maxConcurrency, bufferSize);
    }
    ...
    public static <T> Observable<T> mergeDelayError(Iterable<? extends ObservableSource<? extends T>> sources, int maxConcurrency) {
        return fromIterable(sources).flatMap((Function1) Functions.identity(), true, maxConcurrency);
    }
    ...
    public static <T> Observable<T> mergeDelayError(ObservableSource<? extends ObservableSource<? extends T>> sources) {
        ObjectHelper.requireNonNull(sources, "sources is null");
        return RxJavaObservablePlugins.onAssembly(new ObservableFlatMap(sources, Functions.identity(), true, Integer.MAX_VALUE, bufferSize()));
    }
    ...
    public static <T> Observable<T> mergeDelayError(ObservableSource<? extends ObservableSource<? extends T>> sources, int maxConcurrency) {
        ObjectHelper.requireNonNull(sources, "sources is null");
        ObjectHelper.verifyPositive(maxConcurrency, "maxConcurrency");
        return RxJavaObservablePlugins.onAssembly(new ObservableFlatMap(sources, Functions.identity(), true, maxConcurrency, bufferSize()));
    }
    ...
    public static <T> Observable<T> mergeDelayError(ObservableSource<? extends T> source1, ObservableSource<? extends T> source2) {
        ObjectHelper.requireNonNull(source1, "source1 is null");
        ObjectHelper.requireNonNull(source2, "source2 is null");
        return fromArray(source1, source2).flatMap((Function1) Functions.identity(), true, 2);
    }
    ...
    public static <T> Observable<T> mergeDelayError(ObservableSource<? extends T> source1, ObservableSource<? extends T> source2, ObservableSource<? extends T> source3) {
        ...
        ObjectHelper.requireNonNull(source2, "source2 is null");
        ObjectHelper.requireNonNull(source3, "source3 is null");
        return fromArray(source1, source2, source3).flatMap((Function1) Functions.identity(), true, 3);
    }
    ...
    public static <T> Observable<T> mergeDelayError(
        ...
        ObjectHelper.requireNonNull(source3, "source3 is null");
        ObjectHelper.requireNonNull(source4, "source4 is null");
        return fromArray(source1, source2, source3, source4).flatMap((Function1) Functions.identity(), true, 4);
    }
    ...
    public static <T> Observable<T> mergeArrayDelayError(ObservableSource<? extends T>... sources) {
        return fromArray(sources).flatMap((Function1) Functions.identity(), true, sources.length);
    }
    ...
    public static <T> Observable<T> never() {
        return RxJavaObservablePlugins.onAssembly((Observable<T>) ObservableNever.INSTANCE);
    }
    ...
    public static Observable<Integer> range(final int start, final int count) {
        ...
        return RxJavaObservablePlugins.onAssembly(new ObservableRange(start, count));
    }
    ...
    public static Observable<Long> rangeLong(long start, long count) {
        ...
        return RxJavaObservablePlugins.onAssembly(new ObservableRangeLong(start, count));
    }
    ...
    public static <T> Single<Boolean> sequenceEqual(ObservableSource<? extends T> source1, ObservableSource<? extends T> source2,
        ...
        ObjectHelper.verifyPositive(bufferSize, "bufferSize");
        return RxJavaObservablePlugins.onAssembly(new ObservableSequenceEqualSingle<T>(source1, source2, isEqual, bufferSize));
    }
    ...
    public static <T> Observable<T> switchOnNext(ObservableSource<? extends ObservableSource<? extends T>> sources, int bufferSize) {
        ObjectHelper.requireNonNull(sources, "sources is null");
        ObjectHelper.verifyPositive(bufferSize, "bufferSize");
        return RxJavaObservablePlugins.onAssembly(new ObservableSwitchMap(sources, Functions.identity(), bufferSize, false));
    }
    ...
    public static <T> Observable<T> switchOnNextDelayError(ObservableSource<? extends ObservableSource<? extends T>> sources, int prefetch) {
        ObjectHelper.requireNonNull(sources, "sources is null");
        ObjectHelper.verifyPositive(prefetch, "prefetch");
        return RxJavaObservablePlugins.onAssembly(new ObservableSwitchMap(sources, Functions.identity(), prefetch, true));
    }
    ...
    public static Observable<Long> timer(long delay, TimeUnit unit, Scheduler scheduler) {
        ...
        return RxJavaObservablePlugins.onAssembly(new ObservableTimer(Math.max(delay, 0L), unit, scheduler));
    }
    ...
    public static <T> Observable<T> unsafeCreate(ObservableSource<T> onSubscribe) {
        ...
        return RxJavaObservablePlugins.onAssembly(new ObservableFromUnsafeSource<T>(onSubscribe));
    }
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public static <T, D> Observable<T> using(Callable<? extends D> resourceSupplier, Function1<? super D, ? extends ObservableSource<? extends T>> sourceSupplier, Function1<? super D, kotlin.Unit> disposer) {
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public static <T, D> Observable<T> using(Callable<? extends D> resourceSupplier, Function1<? super D, ? extends ObservableSource<? extends T>> sourceSupplier, Function1<? super D, kotlin.Unit> disposer, boolean eager) {
        ObjectHelper.requireNonNull(resourceSupplier, "resourceSupplier is null");
        ObjectHelper.requireNonNull(sourceSupplier, "sourceSupplier is null");
        ObjectHelper.requireNonNull(disposer, "disposer is null");
        return RxJavaObservablePlugins.onAssembly(new ObservableUsing<T, D>(resourceSupplier, sourceSupplier, disposer, eager));
    }
    ...
    public static <T> Observable<T> wrap(ObservableSource<T> source) {
        ...
        if (source instanceof Observable) {
            return RxJavaObservablePlugins.onAssembly((Observable<T>)source);
        }
        return RxJavaObservablePlugins.onAssembly(new ObservableFromUnsafeSource<T>(source));
    }
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public static <T, R> Observable<R> zip(Iterable<? extends ObservableSource<? extends T>> sources, Function1<? super Object[], ? extends R> zipper) {
        ObjectHelper.requireNonNull(zipper, "zipper is null");
        ObjectHelper.requireNonNull(sources, "sources is null");
        return RxJavaObservablePlugins.onAssembly(new ObservableZip<T, R>(null, sources, zipper, bufferSize(), false));
    }
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public static <T, R> Observable<R> zip(ObservableSource<? extends ObservableSource<? extends T>> sources, final Function1<? super Object[], ? extends R> zipper) {
        ObjectHelper.requireNonNull(zipper, "zipper is null");
        ObjectHelper.requireNonNull(sources, "sources is null");
        return RxJavaObservablePlugins.onAssembly(new ObservableToList(sources, 16)
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public static <T, R> Observable<R> zipArray(Function1<? super Object[], ? extends R> zipper,
        ...
        ObjectHelper.requireNonNull(zipper, "zipper is null");
        ObjectHelper.verifyPositive(bufferSize, "bufferSize");
        return RxJavaObservablePlugins.onAssembly(new ObservableZip<T, R>(sources, null, zipper, bufferSize, delayError));
    }
    ...
    public static <T, R> Observable<R> zipIterable(Iterable<? extends ObservableSource<? extends T>> sources,
                                                   Function1<? super Object[], ? extends R> zipper, boolean delayError,
                                                   int bufferSize) {
        ObjectHelper.requireNonNull(zipper, "zipper is null");
        ObjectHelper.requireNonNull(sources, "sources is null");
        ObjectHelper.verifyPositive(bufferSize, "bufferSize");
        return RxJavaObservablePlugins.onAssembly(new ObservableZip<T, R>(null, sources, zipper, bufferSize, delayError));
    }
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public final Single<Boolean> all(Function1<? super T, Boolean> predicate) {
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public final Single<Boolean> any(Function1<? super T, Boolean> predicate) {
        ObjectHelper.requireNonNull(predicate, "predicate is null");
    ...
    public final <U extends Collection<? super T>> Observable<U> buffer(int count, int skip, Callable<U> bufferSupplier) {
        ...
        return RxJavaObservablePlugins.onAssembly(new ObservableBuffer<T, U>(this, count, skip, bufferSupplier));
    }
    ...
    public final <U extends Collection<? super T>> Observable<U> buffer(long timespan, long timeskip, TimeUnit unit, Scheduler scheduler, Callable<U> bufferSupplier) {
        ...
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        ObjectHelper.requireNonNull(bufferSupplier, "bufferSupplier is null");
        return RxJavaObservablePlugins.onAssembly(new ObservableBufferTimed<T, U>(this, timespan, timeskip, unit, scheduler, bufferSupplier, Integer.MAX_VALUE, false));
    }
    ...
    public final <U extends Collection<? super T>> Observable<U> buffer(
        ...
        ObjectHelper.requireNonNull(bufferSupplier, "bufferSupplier is null");
        ObjectHelper.verifyPositive(count, "count");
        return RxJavaObservablePlugins.onAssembly(new ObservableBufferTimed<T, U>(this, timespan, timespan, unit, scheduler, bufferSupplier, count, restartTimerOnMaxSize));
    }
     ...
     *            the {@link Function1} that is used to produce an ObservableSource for every buffer created. When this
    ...
    public final <TOpening, TClosing> Observable<List<T>> buffer(
            ...
            Function1<? super TOpening, ? extends ObservableSource<? extends TClosing>> closingIndicator) {
    ...
    public final <TOpening, TClosing, U extends Collection<? super T>> Observable<U> buffer(
        ...
        ObjectHelper.requireNonNull(bufferSupplier, "bufferSupplier is null");
        return RxJavaObservablePlugins.onAssembly(new ObservableBufferBoundary<T, U, TOpening, TClosing>(this, openingIndicator, closingIndicator, bufferSupplier));
    }
    ...
    public final <B, U extends Collection<? super T>> Observable<U> buffer(ObservableSource<B> boundary, Callable<U> bufferSupplier) {
        ...
        ObjectHelper.requireNonNull(bufferSupplier, "bufferSupplier is null");
        return RxJavaObservablePlugins.onAssembly(new ObservableBufferExactBoundary<T, U, B>(this, boundary, bufferSupplier));
    }
    ...
    public final <B, U extends Collection<? super T>> Observable<U> buffer(Callable<? extends ObservableSource<B>> boundarySupplier, Callable<U> bufferSupplier) {
        ...
        ObjectHelper.requireNonNull(bufferSupplier, "bufferSupplier is null");
        return RxJavaObservablePlugins.onAssembly(new ObservableBufferBoundarySupplier<T, U, B>(this, boundarySupplier, bufferSupplier));
    }
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public final <R> Observable<R> concatMap(Function1<? super T, ? extends ObservableSource<? extends R>> mapper) {
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public final <R> Observable<R> concatMap(Function1<? super T, ? extends ObservableSource<? extends R>> mapper, int prefetch) {
        ...
        return RxJavaObservablePlugins.onAssembly(new ObservableConcatMap<T, R>(this, mapper, prefetch, ErrorMode.IMMEDIATE));
    }
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public final <R> Observable<R> concatMapDelayError(Function1<? super T, ? extends ObservableSource<? extends R>> mapper) {
    ...
    public final <R> Observable<R> concatMapDelayError(Function1<? super T, ? extends ObservableSource<? extends R>> mapper,
        ...
        return RxJavaObservablePlugins.onAssembly(new ObservableConcatMap<T, R>(this, mapper, prefetch, tillTheEnd ? ErrorMode.END : ErrorMode.BOUNDARY));
    }
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public final <R> Observable<R> concatMapEager(Function1<? super T, ? extends ObservableSource<? extends R>> mapper) {
    ...
    public final <R> Observable<R> concatMapEager(Function1<? super T, ? extends ObservableSource<? extends R>> mapper,
        ...
        ObjectHelper.verifyPositive(maxConcurrency, "maxConcurrency");
        ObjectHelper.verifyPositive(prefetch, "prefetch");
        return RxJavaObservablePlugins.onAssembly(new ObservableConcatMapEager<T, R>(this, mapper, ErrorMode.IMMEDIATE, maxConcurrency, prefetch));
    }
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public final <R> Observable<R> concatMapEagerDelayError(Function1<? super T, ? extends ObservableSource<? extends R>> mapper,
                                                            boolean tillTheEnd) {
    ...
    public final <R> Observable<R> concatMapEagerDelayError(Function1<? super T, ? extends ObservableSource<? extends R>> mapper,
        ...
        ObjectHelper.verifyPositive(maxConcurrency, "maxConcurrency");
        ObjectHelper.verifyPositive(prefetch, "prefetch");
        return RxJavaObservablePlugins.onAssembly(new ObservableConcatMapEager<T, R>(this, mapper, tillTheEnd ? ErrorMode.END : ErrorMode.BOUNDARY, maxConcurrency, prefetch));
    }
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public final <U> Observable<U> concatMapIterable(final Function1<? super T, ? extends Iterable<? extends U>> mapper) {
        ObjectHelper.requireNonNull(mapper, "mapper is null");
        return RxJavaObservablePlugins.onAssembly(new ObservableFlattenIterable<T, U>(this, mapper));
    }
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public final <U> Observable<U> concatMapIterable(final Function1<? super T, ? extends Iterable<? extends U>> mapper, int prefetch) {
        ObjectHelper.requireNonNull(mapper, "mapper is null");
        ObjectHelper.verifyPositive(prefetch, "prefetch");
    ...
    public final Single<Long> count() {
        return RxJavaObservablePlugins.onAssembly(new ObservableCountSingle<T>(this));
    }
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public final <U> Observable<T> debounce(Function1<? super T, ? extends ObservableSource<U>> debounceSelector) {
        ObjectHelper.requireNonNull(debounceSelector, "debounceSelector is null");
        return RxJavaObservablePlugins.onAssembly(new ObservableDebounce<T, U>(this, debounceSelector));
    }
    ...
    public final Observable<T> debounce(long timeout, TimeUnit unit, Scheduler scheduler) {
        ObjectHelper.requireNonNull(unit, "unit is null");
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        return RxJavaObservablePlugins.onAssembly(new ObservableDebounceTimed<T>(this, timeout, unit, scheduler));
    }
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public final <U> Observable<T> delay(final Function1<? super T, ? extends ObservableSource<U>> itemDelay) {
    ...
    public final Observable<T> delay(long delay, TimeUnit unit, Scheduler scheduler, boolean delayError) {
        ...
        return RxJavaObservablePlugins.onAssembly(new ObservableDelay<T>(this, delay, unit, scheduler, delayError));
    }
    ...
    public final <U, V> Observable<T> delay(ObservableSource<U> subscriptionDelay,
                                            Function1<? super T, ? extends ObservableSource<V>> itemDelay) {
    ...
    public final <U> Observable<T> delaySubscription(ObservableSource<U> other) {
        ObjectHelper.requireNonNull(other, "other is null");
        return RxJavaObservablePlugins.onAssembly(new ObservableDelaySubscriptionOther<T, U>(this, other));
    }
    ...
    public final <T2> Observable<T2> dematerialize() {
        ...
        return RxJavaObservablePlugins.onAssembly(new ObservableDematerialize<T2>(m));
    }
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public final <K> Observable<T> distinct(Function1<? super T, K> keySelector) {
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public final <K> Observable<T> distinct(Function1<? super T, K> keySelector, Callable<? extends Collection<? super K>> collectionSupplier) {
        ObjectHelper.requireNonNull(keySelector, "keySelector is null");
        ObjectHelper.requireNonNull(collectionSupplier, "collectionSupplier is null");
        return RxJavaObservablePlugins.onAssembly(new ObservableDistinct<T, K>(this, keySelector, collectionSupplier));
    }
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public final <K> Observable<T> distinctUntilChanged(Function1<? super T, K> keySelector) {
        ObjectHelper.requireNonNull(keySelector, "keySelector is null");
        return RxJavaObservablePlugins.onAssembly(new ObservableDistinctUntilChanged<T, K>(this, keySelector, ObjectHelper.equalsPredicate()));
    }
    ...
    private Observable<T> doOnEach(Function1<? super T, Unit> onNext, Function1<? super Throwable, Unit> onError, Function0 onComplete, Function0 onAfterTerminate) {
        ...
        return RxJavaObservablePlugins.onAssembly(new ObservableDoOnEach<T>(this, onNext, onError, onComplete, onAfterTerminate));
    }
    ...
    public final Maybe<T> elementAt(long index) {
        ...
        return RxJavaObservablePlugins.onAssembly(new ObservableElementAtMaybe<T>(this, index));
    }
    ...
    public final Single<T> elementAt(long index, T defaultItem) {
        ...
        ObjectHelper.requireNonNull(defaultItem, "defaultItem is null");
        return RxJavaObservablePlugins.onAssembly(new ObservableElementAtSingle<T>(this, index, defaultItem));
    }
    ...
    public final Single<T> elementAtOrError(long index) {
        ...
        return RxJavaObservablePlugins.onAssembly(new ObservableElementAtSingle<T>(this, index, null));
    }
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public final Observable<T> filter(Function1<? super T, Boolean> predicate) {
        ObjectHelper.requireNonNull(predicate, "predicate is null");
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public final <R> Observable<R> flatMap(Function1<? super T, ? extends ObservableSource<? extends R>> mapper) {
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public final <R> Observable<R> flatMap(Function1<? super T, ? extends ObservableSource<? extends R>> mapper, boolean delayErrors) {
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public final <R> Observable<R> flatMap(Function1<? super T, ? extends ObservableSource<? extends R>> mapper, boolean delayErrors, int maxConcurrency) {
    ...
    public final <R> Observable<R> flatMap(Function1<? super T, ? extends ObservableSource<? extends R>> mapper,
        ...
        return RxJavaObservablePlugins.onAssembly(new ObservableFlatMap<T, R>(this, mapper, delayErrors, maxConcurrency, bufferSize));
    }
    ...
    public final <R> Observable<R> flatMap(
            Function1<? super T, ? extends ObservableSource<? extends R>> onNextMapper,
            Function1<Throwable, ? extends ObservableSource<? extends R>> onErrorMapper,
            Callable<? extends ObservableSource<? extends R>> onCompleteSupplier,
            int maxConcurrency) {
        ObjectHelper.requireNonNull(onNextMapper, "onNextMapper is null");
        ObjectHelper.requireNonNull(onErrorMapper, "onErrorMapper is null");
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public final <R> Observable<R> flatMap(Function1<? super T, ? extends ObservableSource<? extends R>> mapper, int maxConcurrency) {
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public final Completable flatMapCompletable(Function1<? super T, ? extends CompletableSource> mapper) {
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public final Completable flatMapCompletable(Function1<? super T, ? extends CompletableSource> mapper, boolean delayErrors) {
        ObjectHelper.requireNonNull(mapper, "mapper is null");
        return RxJavaObservablePlugins.onAssembly(new ObservableFlatMapCompletableCompletable<T>(this, mapper, delayErrors));
    }
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public final <U> Observable<U> flatMapIterable(final Function1<? super T, ? extends Iterable<? extends U>> mapper) {
        ObjectHelper.requireNonNull(mapper, "mapper is null");
        return RxJavaObservablePlugins.onAssembly(new ObservableFlattenIterable<T, U>(this, mapper));
    }
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public final <R> Observable<R> flatMapMaybe(Function1<? super T, ? extends MaybeSource<? extends R>> mapper) {
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public final <R> Observable<R> flatMapMaybe(Function1<? super T, ? extends MaybeSource<? extends R>> mapper, boolean delayErrors) {
        ObjectHelper.requireNonNull(mapper, "mapper is null");
        return RxJavaObservablePlugins.onAssembly(new ObservableFlatMapMaybe<T, R>(this, mapper, delayErrors));
    }
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public final <R> Observable<R> flatMapSingle(Function1<? super T, ? extends SingleSource<? extends R>> mapper) {
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public final <R> Observable<R> flatMapSingle(Function1<? super T, ? extends SingleSource<? extends R>> mapper, boolean delayErrors) {
        ObjectHelper.requireNonNull(mapper, "mapper is null");
        return RxJavaObservablePlugins.onAssembly(new ObservableFlatMapSingle<T, R>(this, mapper, delayErrors));
    }
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public final Disposable forEachWhile(Function1<? super T, Boolean> onNext) {
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public final <K> Observable<GroupedObservable<K, T>> groupBy(Function1<? super T, ? extends K> keySelector) {
        return groupBy(keySelector, (Function1) Functions.identity(), false, bufferSize());
    }
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public final <K> Observable<GroupedObservable<K, T>> groupBy(Function1<? super T, ? extends K> keySelector, boolean delayError) {
        return groupBy(keySelector, (Function1) Functions.identity(), delayError, bufferSize());
    }
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public final <K, V> Observable<GroupedObservable<K, V>> groupBy(Function1<? super T, ? extends K> keySelector,
    ...
    @SchedulerSupport(SchedulerSupport.NONE)
    public final <K, V> Observable<GroupedObservable<K, V>> groupBy(Function1<? super T, ? extends K> keySelector,
                                                                    Function1<? super T, ? extends V> valueSelector, boolean delayError) {
    ...
    public final <K, V> Observable<GroupedObservable<K, V>> groupBy(Function1<? super T, ? extends K> keySelector,
        ...
        return RxJavaObservablePlugins.onAssembly(new ObservableGroupBy<T, K, V>(this, keySelector, valueSelector, bufferSize, delayError));
    }
    ...
    public final <TRight, TLeftEnd, TRightEnd, R> Observable<R> groupJoin(
        ...
        ObjectHelper.requireNonNull(resultSelector, "resultSelector is null");
        return RxJavaObservablePlugins.onAssembly(new ObservableGroupJoin<T, TRight, TLeftEnd, TRightEnd, R>(
    ...
    public final Observable<T> hide() {
        return RxJavaObservablePlugins.onAssembly(new ObservableHide<T>(this));
    }
    ...
    public final Completable ignoreElements() {
        return RxJavaObservablePlugins.onAssembly(new ObservableIgnoreElementsCompletable<T>(this));
    }
    ...
    public final <TRight, TLeftEnd, TRightEnd, R> Observable<R> join(
        ...
        ObjectHelper.requireNonNull(rightEnd, "rightEnd is null");
        ObjectHelper.requireNonNull(resultSelector, "resultSelector is null");
        return RxJavaObservablePlugins.onAssembly(new ObservableJoin<T, TRight, TLeftEnd, TRightEnd, R>(
                this, other, leftEnd, rightEnd, resultSelector));
    }
    ...
    public final Maybe<T> lastElement() {
        return RxJavaObservablePlugins.onAssembly(new ObservableLastMaybe<T>(this));
    }
    ...
    public final Single<T> last(T defaultItem) {
        ObjectHelper.requireNonNull(defaultItem, "defaultItem is null");
        return RxJavaObservablePlugins.onAssembly(new ObservableLastSingle<T>(this, defaultItem));
    }
    ...
    public final Single<T> lastOrError() {
        return RxJavaObservablePlugins.onAssembly(new ObservableLastSingle<T>(this, null));
    }
    ...
    public final <R> Observable<R> lift(ObservableOperator<? extends R, ? super T> lifter) {
        ...
        return RxJavaObservablePlugins.onAssembly(new ObservableLift<R, T>(this, lifter));
    }
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public final <R> Observable<R> map(Function1<? super T, ? extends R> mapper) {
        ObjectHelper.requireNonNull(mapper, "mapper is null");
        return RxJavaObservablePlugins.onAssembly(new ObservableMap<T, R>(this, mapper));
    }
    ...
    public final Observable<Notification<T>> materialize() {
        return RxJavaObservablePlugins.onAssembly(new ObservableMaterialize<T>(this));
    }
    ...
    public final Observable<T> observeOn(Scheduler scheduler, boolean delayError, int bufferSize) {
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        ObjectHelper.verifyPositive(bufferSize, "bufferSize");
        return RxJavaObservablePlugins.onAssembly(new ObservableObserveOn<T>(this, scheduler, delayError, bufferSize));
    }
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public final Observable<T> onErrorResumeNext(Function1<? super Throwable, ? extends ObservableSource<? extends T>> resumeFunction) {
        ObjectHelper.requireNonNull(resumeFunction, "resumeFunction is null");
        return RxJavaObservablePlugins.onAssembly(new ObservableOnErrorNext<T>(this, resumeFunction, false));
    }
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public final Observable<T> onErrorReturn(Function1<? super Throwable, ? extends T> valueSupplier) {
        ObjectHelper.requireNonNull(valueSupplier, "valueSupplier is null");
        return RxJavaObservablePlugins.onAssembly(new ObservableOnErrorReturn<T>(this, valueSupplier));
    }
    ...
    public final Observable<T> onExceptionResumeNext(final ObservableSource<? extends T> next) {
        ObjectHelper.requireNonNull(next, "next is null");
        return RxJavaObservablePlugins.onAssembly(new ObservableOnErrorNext<T>(this, Functions.justFunction(next), true));
    }
    ...
    public final Observable<T> onTerminateDetach() {
        return RxJavaObservablePlugins.onAssembly(new ObservableDetach<T>(this));
    }
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public final <R> Observable<R> publish(Function1<? super Observable<T>, ? extends ObservableSource<R>> selector) {
        ObjectHelper.requireNonNull(selector, "selector is null");
        return RxJavaObservablePlugins.onAssembly(new ObservablePublishSelector<T, R>(this, selector));
    }
    ...
    public final Observable<T> repeat(long times) {
        ...
        return RxJavaObservablePlugins.onAssembly(new ObservableRepeat<T>(this, times));
    }
    ...
    public final Observable<T> repeatUntil(Function0<Boolean> stop) {
        ...
        return RxJavaObservablePlugins.onAssembly(new ObservableRepeatUntil<T>(this, stop));
    }
    ...
    public final Observable<T> repeatWhen(final Function1<? super Observable<Object>, ? extends ObservableSource<?>> handler) {
        ...
        return RxJavaObservablePlugins.onAssembly(new ObservableRepeatWhen<T>(this, handler));
    }
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public final <R> Observable<R> replay(Function1<? super Observable<T>, ? extends ObservableSource<R>> selector) {
        ObjectHelper.requireNonNull(selector, "selector is null");
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public final <R> Observable<R> replay(Function1<? super Observable<T>, ? extends ObservableSource<R>> selector, final int bufferSize) {
        ObjectHelper.requireNonNull(selector, "selector is null");
        ObjectHelper.verifyPositive(bufferSize, "bufferSize");
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.COMPUTATION)
    public final <R> Observable<R> replay(Function1<? super Observable<T>, ? extends ObservableSource<R>> selector, int bufferSize, long time, TimeUnit unit) {
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.CUSTOM)
    public final <R> Observable<R> replay(Function1<? super Observable<T>, ? extends ObservableSource<R>> selector, final int bufferSize, final long time, final TimeUnit unit, final Scheduler scheduler) {
        ObjectHelper.requireNonNull(selector, "selector is null");
        ObjectHelper.verifyPositive(bufferSize, "bufferSize");
        ObjectHelper.requireNonNull(unit, "unit is null");
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.CUSTOM)
    public final <R> Observable<R> replay(final Function1<? super Observable<T>, ? extends ObservableSource<R>> selector, final int bufferSize, final Scheduler scheduler) {
        ObjectHelper.requireNonNull(selector, "selector is null");
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        ObjectHelper.verifyPositive(bufferSize, "bufferSize");
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.COMPUTATION)
    public final <R> Observable<R> replay(Function1<? super Observable<T>, ? extends ObservableSource<R>> selector, long time, TimeUnit unit) {
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.CUSTOM)
    public final <R> Observable<R> replay(Function1<? super Observable<T>, ? extends ObservableSource<R>> selector, final long time, final TimeUnit unit, final Scheduler scheduler) {
        ObjectHelper.requireNonNull(selector, "selector is null");
        ObjectHelper.requireNonNull(unit, "unit is null");
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.CUSTOM)
    public final <R> Observable<R> replay(final Function1<? super Observable<T>, ? extends ObservableSource<R>> selector, final Scheduler scheduler) {
        ObjectHelper.requireNonNull(selector, "selector is null");
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public final Observable<T> retry(long times, Function1<? super Throwable, Boolean> predicate) {
        if (times < 0) {
            throw new IllegalArgumentException("times >= 0 required but it was " + times);
        }
        ObjectHelper.requireNonNull(predicate, "predicate is null");

        return RxJavaObservablePlugins.onAssembly(new ObservableRetryPredicate<T>(this, times, predicate));
    }
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public final Observable<T> retry(Function1<? super Throwable, Boolean> predicate) {
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public final Observable<T> retryUntil(final Function0<Boolean> stop) {
        ObjectHelper.requireNonNull(stop, "stop is null");
    ...
    public final Observable<T> retryWhen(
        ...
        ObjectHelper.requireNonNull(handler, "handler is null");
        return RxJavaObservablePlugins.onAssembly(new ObservableRetryWhen<T>(this, handler));
    }
    ...
    public final Observable<T> sample(long period, TimeUnit unit, Scheduler scheduler) {
        ObjectHelper.requireNonNull(unit, "unit is null");
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        return RxJavaObservablePlugins.onAssembly(new ObservableSampleTimed<T>(this, period, unit, scheduler, false));
    }
    ...
    public final Observable<T> sample(long period, TimeUnit unit, Scheduler scheduler, boolean emitLast) {
        ObjectHelper.requireNonNull(unit, "unit is null");
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        return RxJavaObservablePlugins.onAssembly(new ObservableSampleTimed<T>(this, period, unit, scheduler, emitLast));
    }
    ...
    public final <U> Observable<T> sample(ObservableSource<U> sampler) {
        ...
        return RxJavaObservablePlugins.onAssembly(new ObservableSampleWithObservable<T>(this, sampler, false));
    }
    ...
    public final <U> Observable<T> sample(ObservableSource<U> sampler, boolean emitLast) {
        ObjectHelper.requireNonNull(sampler, "sampler is null");
        return RxJavaObservablePlugins.onAssembly(new ObservableSampleWithObservable<T>(this, sampler, emitLast));
    }
    ...
    public final Observable<T> serialize() {
        return RxJavaObservablePlugins.onAssembly(new ObservableSerialized<T>(this));
    }
    ...
    public final Maybe<T> singleElement() {
        return RxJavaObservablePlugins.onAssembly(new ObservableSingleMaybe<T>(this));
    }
    ...
    public final Single<T> single(T defaultItem) {
        ObjectHelper.requireNonNull(defaultItem, "defaultItem is null");
        return RxJavaObservablePlugins.onAssembly(new ObservableSingleSingle<T>(this, defaultItem));
    }
    ...
    public final Single<T> singleOrError() {
        return RxJavaObservablePlugins.onAssembly(new ObservableSingleSingle<T>(this, null));
    }
    ...
    public final Observable<T> skip(long count) {
        ...
        return RxJavaObservablePlugins.onAssembly(new ObservableSkip<T>(this, count));
    }
    ...
    public final Observable<T> skipLast(int count) {
        ...
        return RxJavaObservablePlugins.onAssembly(new ObservableSkipLast<T>(this, count));
    }
    ...
    public final Observable<T> skipLast(long time, TimeUnit unit, Scheduler scheduler, boolean delayError, int bufferSize) {
        ...
        int s = bufferSize << 1;
        return RxJavaObservablePlugins.onAssembly(new ObservableSkipLastTimed<T>(this, time, unit, scheduler, s, delayError));
    }
    ...
    public final <U> Observable<T> skipUntil(ObservableSource<U> other) {
        ObjectHelper.requireNonNull(other, "other is null");
        return RxJavaObservablePlugins.onAssembly(new ObservableSkipUntil<T, U>(this, other));
    }
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public final Observable<T> skipWhile(Function1<? super T, Boolean> predicate) {
        ObjectHelper.requireNonNull(predicate, "predicate is null");
    ...
    public final Observable<T> subscribeOn(Scheduler scheduler) {
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        return RxJavaObservablePlugins.onAssembly(new ObservableSubscribeOn<T>(this, scheduler));
    }
    ...
    public final Observable<T> switchIfEmpty(ObservableSource<? extends T> other) {
        ObjectHelper.requireNonNull(other, "other is null");
        return RxJavaObservablePlugins.onAssembly(new ObservableSwitchIfEmpty<T>(this, other));
    }
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public final <R> Observable<R> switchMap(Function1<? super T, ? extends ObservableSource<? extends R>> mapper) {
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public final <R> Observable<R> switchMap(Function1<? super T, ? extends ObservableSource<? extends R>> mapper, int bufferSize) {
        ObjectHelper.requireNonNull(mapper, "mapper is null");
        ObjectHelper.verifyPositive(bufferSize, "bufferSize");
        if (this instanceof ScalarCallable) {
            @SuppressWarnings("unchecked")
        ...
        return RxJavaObservablePlugins.onAssembly(new ObservableSwitchMap<T, R>(this, mapper, bufferSize, false));
    }
    ...
    @SchedulerSupport(SchedulerSupport.NONE)
    @NonNull
    public final <R> Observable<R> switchMapSingle(@NonNull Function1<? super T, ? extends SingleSource<? extends R>> mapper) {
    ...
    @SchedulerSupport(SchedulerSupport.NONE)
    @NonNull
    public final <R> Observable<R> switchMapSingleDelayError(@NonNull Function1<? super T, ? extends SingleSource<? extends R>> mapper) {
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public final <R> Observable<R> switchMapDelayError(Function1<? super T, ? extends ObservableSource<? extends R>> mapper) {
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public final <R> Observable<R> switchMapDelayError(Function1<? super T, ? extends ObservableSource<? extends R>> mapper, int bufferSize) {
        ObjectHelper.requireNonNull(mapper, "mapper is null");
        ObjectHelper.verifyPositive(bufferSize, "bufferSize");
        if (this instanceof ScalarCallable) {
            @SuppressWarnings("unchecked")
        ...
        return RxJavaObservablePlugins.onAssembly(new ObservableSwitchMap<T, R>(this, mapper, bufferSize, true));
    }
    ...
    public final Observable<T> take(long count) {
        ...
        return RxJavaObservablePlugins.onAssembly(new ObservableTake<T>(this, count));
    }
    ...
    public final Observable<T> takeLast(int count) {
        ...
        if (count == 0) {
            return RxJavaObservablePlugins.onAssembly(new ObservableIgnoreElements<T>(this));
        } else
        if (count == 1) {
            return RxJavaObservablePlugins.onAssembly(new ObservableTakeLastOne<T>(this));
        }
        return RxJavaObservablePlugins.onAssembly(new ObservableTakeLast<T>(this, count));
    }
    ...
    public final Observable<T> takeLast(long count, long time, TimeUnit unit, Scheduler scheduler, boolean delayError, int bufferSize) {
        ...
        return RxJavaObservablePlugins.onAssembly(new ObservableTakeLastTimed<T>(this, count, time, unit, scheduler, bufferSize, delayError));
    }
    ...
    public final <U> Observable<T> takeUntil(ObservableSource<U> other) {
        ObjectHelper.requireNonNull(other, "other is null");
        return RxJavaObservablePlugins.onAssembly(new ObservableTakeUntil<T, U>(this, other));
    }
     ...
     * <p>
     * The difference between this operator and {@link #takeWhile(Function1)} is that here, the condition is
     ...
     * @see <a href="http://reactivex.io/documentation/operators/takeuntil.html">ReactiveX operators documentation: TakeUntil</a>
     * @see Observable#takeWhile(Function1)
     * @since 1.1.0
     */
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public final Observable<T> takeUntil(Function1<? super T, Boolean> stopPredicate) {
     ...
     * @see Observable#takeUntil(Function1)
     */
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public final Observable<T> takeWhile(Function1<? super T, Boolean> predicate) {
        ObjectHelper.requireNonNull(predicate, "predicate is null");
    ...
    public final Observable<T> throttleFirst(long skipDuration, TimeUnit unit, Scheduler scheduler) {
        ObjectHelper.requireNonNull(unit, "unit is null");
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        return RxJavaObservablePlugins.onAssembly(new ObservableThrottleFirstTimed<T>(this, skipDuration, unit, scheduler));
    }
    ...
    public final Observable<Timed<T>> timeInterval(TimeUnit unit, Scheduler scheduler) {
        ObjectHelper.requireNonNull(unit, "unit is null");
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        return RxJavaObservablePlugins.onAssembly(new ObservableTimeInterval<T>(this, unit, scheduler));
    }
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public final <V> Observable<T> timeout(Function1<? super T, ? extends ObservableSource<V>> itemTimeoutIndicator) {
    ...
    private Observable<T> timeout0(long timeout, TimeUnit timeUnit, ObservableSource<? extends T> other,
        ...
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        return RxJavaObservablePlugins.onAssembly(new ObservableTimeoutTimed<T>(this, timeout, timeUnit, scheduler, other));
    }
    ...
    private <U, V> Observable<T> timeout0(
        ...
        return RxJavaObservablePlugins.onAssembly(new ObservableTimeout<T, U, V>(this, firstTimeoutIndicator, itemTimeoutIndicator, other));
    }
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public final <R> R to(Function1<? super Observable<T>, R> converter) {
        try {
    ...
    public final Single<List<T>> toList(final int capacityHint) {
        ...
        return RxJavaObservablePlugins.onAssembly(new ObservableToListSingle<T, List<T>>(this, capacityHint));
    }
    ...
    public final <U extends Collection<? super T>> Single<U> toList(Callable<U> collectionSupplier) {
        ObjectHelper.requireNonNull(collectionSupplier, "collectionSupplier is null");
        return RxJavaObservablePlugins.onAssembly(new ObservableToListSingle<T, U>(this, collectionSupplier));
    }
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public final <K> Single<Map<K, T>> toMap(final Function1<? super T, ? extends K> keySelector) {
        ObjectHelper.requireNonNull(keySelector, "keySelector is null");
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public final <K> Single<Map<K, Collection<T>>> toMultimap(Function1<? super T, ? extends K> keySelector) {
        @SuppressWarnings({ "rawtypes", "unchecked" })
        Function1<? super T, ? extends T> valueSelector = (Function1) Functions.identity();
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public final <K, V> Single<Map<K, Collection<V>>> toMultimap(Function1<? super T, ? extends K> keySelector, Function1<? super T, ? extends V> valueSelector) {
    ...
    public final Observable<T> unsubscribeOn(Scheduler scheduler) {
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        return RxJavaObservablePlugins.onAssembly(new ObservableUnsubscribeOn<T>(this, scheduler));
    }
    ...
    public final Observable<Observable<T>> window(long count, long skip, int bufferSize) {
        ...
        ObjectHelper.verifyPositive(skip, "skip");
        ObjectHelper.verifyPositive(bufferSize, "bufferSize");
        return RxJavaObservablePlugins.onAssembly(new ObservableWindow<T>(this, count, skip, bufferSize));
    }
    ...
    public final Observable<Observable<T>> window(long timespan, long timeskip, TimeUnit unit, Scheduler scheduler, int bufferSize) {
        ...
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        ObjectHelper.requireNonNull(unit, "unit is null");
        return RxJavaObservablePlugins.onAssembly(new ObservableWindowTimed<T>(this, timespan, timeskip, unit, scheduler, Long.MAX_VALUE, bufferSize, false));
    }
    ...
    public final Observable<Observable<T>> window(
        ...
        ObjectHelper.requireNonNull(unit, "unit is null");
        ObjectHelper.verifyPositive(count, "count");
        return RxJavaObservablePlugins.onAssembly(new ObservableWindowTimed<T>(this, timespan, timespan, unit, scheduler, count, bufferSize, restart));
    }
    ...
    public final <B> Observable<Observable<T>> window(ObservableSource<B> boundary, int bufferSize) {
        ObjectHelper.requireNonNull(boundary, "boundary is null");
        ObjectHelper.verifyPositive(bufferSize, "bufferSize");
        return RxJavaObservablePlugins.onAssembly(new ObservableWindowBoundary<T, B>(this, boundary, bufferSize));
    }
     ...
     * @param closingIndicator
     *            a {@link Function1} that produces an ObservableSource for every window created. When this ObservableSource
    ...
    public final <U, V> Observable<Observable<T>> window(
            ...
            Function1<? super U, ? extends ObservableSource<V>> closingIndicator) {
    ...
    public final <U, V> Observable<Observable<T>> window(
            ObservableSource<U> openingIndicator,
            Function1<? super U, ? extends ObservableSource<V>> closingIndicator, int bufferSize) {
        ObjectHelper.requireNonNull(openingIndicator, "openingIndicator is null");
        ObjectHelper.requireNonNull(closingIndicator, "closingIndicator is null");
        ObjectHelper.verifyPositive(bufferSize, "bufferSize");
        return RxJavaObservablePlugins.onAssembly(new ObservableWindowBoundarySelector<T, U, V>(this, openingIndicator, closingIndicator, bufferSize));
    }
    ...
    public final <B> Observable<Observable<T>> window(Callable<? extends ObservableSource<B>> boundary, int bufferSize) {
        ObjectHelper.requireNonNull(boundary, "boundary is null");
        ObjectHelper.verifyPositive(bufferSize, "bufferSize");
        return RxJavaObservablePlugins.onAssembly(new ObservableWindowBoundarySupplier<T, B>(this, boundary, bufferSize));
    }
    ...
    public final <U, R> Observable<R> withLatestFrom(ObservableSource<? extends U> other, BiFunction<? super T, ? super U, ? extends R> combiner) {
        ...
        return RxJavaObservablePlugins.onAssembly(new ObservableWithLatestFrom<T, U, R>(this, combiner, other));
    }
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public final <R> Observable<R> withLatestFrom(ObservableSource<?>[] others, Function1<? super Object[], R> combiner) {
        ObjectHelper.requireNonNull(others, "others is null");
        ObjectHelper.requireNonNull(combiner, "combiner is null");
        return RxJavaObservablePlugins.onAssembly(new ObservableWithLatestFromMany<T, R>(this, others, combiner));
    }
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public final <R> Observable<R> withLatestFrom(Iterable<? extends ObservableSource<?>> others, Function1<? super Object[], R> combiner) {
        ObjectHelper.requireNonNull(others, "others is null");
        ObjectHelper.requireNonNull(combiner, "combiner is null");
        return RxJavaObservablePlugins.onAssembly(new ObservableWithLatestFromMany<T, R>(this, others, combiner));
    }
