...
public abstract class Single<T> implements SingleSource<T> {
    ...
    public static <T> Single<T> amb(final Iterable<? extends SingleSource<? extends T>> sources) {
        ...
        return RxJavaObservablePlugins.onAssembly(new SingleAmb<T>(null, sources));
    }
    ...
    public static <T> Single<T> ambArray(final SingleSource<? extends T>... sources) {
        ...
        return RxJavaObservablePlugins.onAssembly(new SingleAmb<T>(sources, null));
    }
    ...
    @SchedulerSupport(SchedulerSupport.NONE)
    @SuppressWarnings({ "unchecked", "rawtypes" })
    public static <T> Observable<T> concat(ObservableSource<? extends SingleSource<? extends T>> sources, int prefetch) {
        ObjectHelper.requireNonNull(sources, "sources is null");
    ...
    @SchedulerSupport(SchedulerSupport.NONE)
    @SuppressWarnings({ "unchecked", "rawtypes" })
    public static <T> Observable<T> concatArray(SingleSource<? extends T>... sources) {
    ...
    public static <T> Single<T> create(SingleOnSubscribe<T> source) {
        ...
        return RxJavaObservablePlugins.onAssembly(new SingleCreate<T>(source));
    }
    ...
    public static <T> Single<T> defer(final Callable<? extends SingleSource<? extends T>> singleSupplier) {
        ...
        return RxJavaObservablePlugins.onAssembly(new SingleDefer<T>(singleSupplier));
    }
    ...
    public static <T> Single<T> error(final Callable<? extends Throwable> errorSupplier) {
        ...
        return RxJavaObservablePlugins.onAssembly(new SingleError<T>(errorSupplier));
    }
    ...
    public static <T> Single<T> fromCallable(final Callable<? extends T> callable) {
        ...
        return RxJavaObservablePlugins.onAssembly(new SingleFromCallable<T>(callable));
    }
    ...
    public static <T> Single<T> fromFuture(Future<? extends T> future) {
        return toSingle(Observable.<T>fromFuture(future));
    }
    ...
    public static <T> Single<T> fromFuture(Future<? extends T> future, long timeout, TimeUnit unit) {
        return toSingle(Observable.<T>fromFuture(future, timeout, unit));
    }
    ...
    public static <T> Single<T> fromFuture(Future<? extends T> future, long timeout, TimeUnit unit, Scheduler scheduler) {
        return toSingle(Observable.<T>fromFuture(future, timeout, unit, scheduler));
    }
    ...
    public static <T> Single<T> fromFuture(Future<? extends T> future, Scheduler scheduler) {
        return toSingle(Observable.<T>fromFuture(future, scheduler));
    }
    ...
    public static <T> Single<T> fromObservable(ObservableSource<? extends T> observableSource) {
        ...
        return RxJavaObservablePlugins.onAssembly(new ObservableSingleSingle<T>(observableSource, null));
    }
    ...
    public static <T> Single<T> just(final T item) {
        ...
        return RxJavaObservablePlugins.onAssembly(new SingleJust<T>(item));
    }
    ...
    @SchedulerSupport(SchedulerSupport.NONE)
    @SuppressWarnings({ "unchecked", "rawtypes" })
    public static <T> Observable<T> merge(ObservableSource<? extends SingleSource<? extends T>> sources) {
        ObjectHelper.requireNonNull(sources, "sources is null");
    ...
    public static <T> Single<T> never() {
        return RxJavaObservablePlugins.onAssembly((Single<T>) SingleNever.INSTANCE);
    }
    ...
    public static <T> Single<Boolean> equals(final SingleSource<? extends T> first, final SingleSource<? extends T> second) { // NOPMD
        ...
        return RxJavaObservablePlugins.onAssembly(new SingleEquals<T>(first, second));
    }
    ...
    public static <T> Single<T> unsafeCreate(SingleSource<T> onSubscribe) {
        ...
        return RxJavaObservablePlugins.onAssembly(new SingleFromUnsafeSource<T>(onSubscribe));
    }
    ...
    public static <T, U> Single<T> using(
        ...
        return RxJavaObservablePlugins.onAssembly(new SingleUsing<T, U>(resourceSupplier, singleFunction, disposer, eager));
    }
    ...
    public static <T> Single<T> wrap(SingleSource<T> source) {
        ...
        if (source instanceof Single) {
            return RxJavaObservablePlugins.onAssembly((Single<T>)source);
        }
        return RxJavaObservablePlugins.onAssembly(new SingleFromUnsafeSource<T>(source));
    }
    ...
    public static <T, R> Single<R> zipArray(Function1<? super Object[], ? extends R> zipper, SingleSource<? extends T>... sources) {
        ...
        return RxJavaObservablePlugins.onAssembly(new SingleZipArray<T, R>(sources, zipper));
    }
    ...
    public final Single<T> hide() {
        return RxJavaObservablePlugins.onAssembly(new SingleHide<T>(this));
    }
    ...
    public final Single<T> cache() {
        return RxJavaObservablePlugins.onAssembly(new SingleCache<T>(this));
    }
    ...
    public final Single<T> delay(final long time, final TimeUnit unit, final Scheduler scheduler) {
        ObjectHelper.requireNonNull(unit, "unit is null");
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        return RxJavaObservablePlugins.onAssembly(new SingleDelay<T>(this, time, unit, scheduler));
    }
    ...
    public final Single<T> delaySubscription(CompletableSource other) {
        ObjectHelper.requireNonNull(other, "other is null");
        return RxJavaObservablePlugins.onAssembly(new SingleDelayWithCompletable<T>(this, other));
    }
    ...
    public final <U> Single<T> delaySubscription(SingleSource<U> other) {
        ObjectHelper.requireNonNull(other, "other is null");
        return RxJavaObservablePlugins.onAssembly(new SingleDelayWithSingle<T, U>(this, other));
    }
    ...
    public final <U> Single<T> delaySubscription(ObservableSource<U> other) {
        ObjectHelper.requireNonNull(other, "other is null");
        return RxJavaObservablePlugins.onAssembly(new SingleDelayWithObservable<T, U>(this, other));
    }
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public final Single<T> doOnEvent(final Function2<? super T, ? super Throwable, Unit> onEvent) {
        ObjectHelper.requireNonNull(onEvent, "onEvent is null");
        return RxJavaObservablePlugins.onAssembly(new SingleDoOnEvent<T>(this, onEvent));
    }
    ...
    public final <R> Single<R> lift(final SingleOperator<? extends R, ? super T> lift) {
        ...
        return RxJavaObservablePlugins.onAssembly(new SingleLift<T, R>(this, lift));
    }
    ...
    public final Single<T> observeOn(final Scheduler scheduler) {
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        return RxJavaObservablePlugins.onAssembly(new SingleObserveOn<T>(this, scheduler));
    }
    ...
    public final Single<T> onErrorReturnItem(final T value) {
        ObjectHelper.requireNonNull(value, "value is null");
        return RxJavaObservablePlugins.onAssembly(new SingleOnErrorReturn<T>(this, null, value));
    }
    ...
    public final Single<T> retry() {
        return toSingle(toObservable().retry());
    }
    ...
    public final Single<T> retry(long times) {
        return toSingle(toObservable().retry(times));
    }
    ...
    public final void subscribe(SingleObserver<? super T> subscriber) {
        ...
        subscriber = RxJavaObservablePlugins.onSubscribe(this, subscriber);

        ObjectHelper.requireNonNull(subscriber, "subscriber returned by the RxJavaObservablePlugins hook is null");
    ...
    public final Single<T> subscribeOn(final Scheduler scheduler) {
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        return RxJavaObservablePlugins.onAssembly(new SingleSubscribeOn<T>(this, scheduler));
    }
    ...
    public final Single<T> takeUntil(final CompletableSource other) {
        ObjectHelper.requireNonNull(other, "other is null");
        return takeUntil(new CompletableToObservable<T>(other));
    }
     ...
     *
     * @param other
     *            the ObservableSource whose first emitted item will cause {@code takeUntil} to emit the item from the source
     *            Single
     * @param <E>
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public final <E> Single<T> takeUntil(final ObservableSource<E> other) {
        ObjectHelper.requireNonNull(other, "other is null");
        return RxJavaObservablePlugins.onAssembly(new SingleTakeUntil<T, E>(this, other));
    }
    ...
    public final <E> Single<T> takeUntil(final SingleSource<? extends E> other) {
        ObjectHelper.requireNonNull(other, "other is null");
        return takeUntil(new SingleToObservable<E>(other));
    }
    ...
    private Single<T> timeout0(final long timeout, final TimeUnit unit, final Scheduler scheduler, final SingleSource<? extends T> other) {
        ObjectHelper.requireNonNull(unit, "unit is null");
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        return RxJavaObservablePlugins.onAssembly(new SingleTimeout<T>(this, timeout, unit, scheduler, other));
    }
    ...
    public final Completable toCompletable() {
        return RxJavaObservablePlugins.onAssembly(new CompletableFromSingle<T>(this));
    }
    ...
    public final Maybe<T> toMaybe() {
        ...
        return RxJavaObservablePlugins.onAssembly(new MaybeFromSingle<T>(this));
    }
    /**
    ...
    private static <T> Single<T> toSingle(Observable<T> source) {
        return RxJavaObservablePlugins.onAssembly(new ObservableSingleSingle<T>(source, null));
    }
}
