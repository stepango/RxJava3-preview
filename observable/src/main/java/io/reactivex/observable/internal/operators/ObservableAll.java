...
public final class ObservableAll<T> extends AbstractObservableWithUpstream<T, Boolean> {
    ...
    public ObservableAll(ObservableSource<T> source, Function1<? super T, Boolean> predicate) {
        super(source);
    ...
    static final class AllObserver<T> implements Observer<T>, Disposable {
        ...
        AllObserver(Observer<? super Boolean> actual, Function1<? super T, Boolean> predicate) {
            this.actual = actual;
            this.predicate = predicate;
        }
        @Override
